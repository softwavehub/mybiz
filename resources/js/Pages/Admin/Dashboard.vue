...
import { ShieldAlert, DollarSign, PackageCheck, AlertTriangle, Activity } from 'lucide-vue-next';
...
const strikeList = props.strikes || [
...
const escrowList = props.escrows || [
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6">
        ...
        <div className="space-y-4">
          <div v-for="s in strikeList" :key="s.id" className="bg-slate-950/60 border border-slate-800 p-4 rounded-xl flex items-center justify-between">
            <div>
      ...
      <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6">
        ...
        <div className="space-y-4">
          <div v-for="e in escrowList" :key="e.id" className="bg-slate-950/60 border border-slate-800 p-4 rounded-xl flex items-center justify-between text-sm">
            <div>

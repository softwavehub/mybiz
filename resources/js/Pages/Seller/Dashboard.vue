...
import { Package, Truck, Printer, PlusCircle } from 'lucide-vue-next';
...
const shippingZones = ref({ zoneA: 30, zoneB: 50, zoneC: 80 });
...
<template>
  <div className="min-h-screen bg-slate-950 text-slate-100 font-sans p-6">
    ...
    <div className="space-y-4">
      <div v-for="o in orderList" :key="o.id" className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
